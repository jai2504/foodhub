  ...
  bcrypt
    ...
    .then((savedUser) => {
      const msg = {
        ...
        from: '18bcs1051@cuchd.in', // Change to your verified sender
        subject: 'Verify Your Foodholic Account',
        text: 'Your Account is Ready Verify it to explore',
        html: `
